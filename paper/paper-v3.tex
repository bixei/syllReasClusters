...
In order to determine the required factors that are necessary for the evaluation of an adequate cognitive theory, we take~the suggestion by Ragni and Stolzburg~\cite{ragni:stolzenburg:2015} as a starting point:
...
We have investigated the cognitive adequacy of clustering by principles under WCS with respect to the individual answer patterns reported by Johnson-Laird and Khemlanid~\cite{khemlani:2016}.
