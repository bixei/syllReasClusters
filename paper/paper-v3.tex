...
\cite{khemlani:2016}\todo{R: cite als Konstituent} proposed an approach to model the individual reasoning patterns of the participants, and 
...
They\todo{R: oder doch ``Khemlani''? ;)} specified four parameters for the construction of a mental model and evaluated their
...
\cite{khemlani:2016}\todo{R: cite als Konstituent} identified three different reasoning clusters: The intuitive cluster, the intermediate cluster and the deliberative cluster.
...
\cite{khemlani:2016}\todo{R: cite als Konstituent} is the only approach we are aware of that has evaluated predictions on human syllogistic reasoning
