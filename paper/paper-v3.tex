...
Another aspect that would be intersting to investigate is in how far the $\cxt$ operator within the extended three-valued {\L}ukasiewicz logic,
originally presented in~\cite{}, 
 corresponds to the {\L}ukasiewicz extensional necessity operator~\cite{}.\footnote{Thanks to the reviewer for this observation.}
