...
% A major drawback of 
The results of the meta-study on syllogistic reasoning in~\cite{khemlani:2012} show that the answers given by humans doe not only systematically differ from the valid conclusions under CL, but from any other proposed cognitive theory (cf.~\cite{BJ89,johnsonlaird:1983,Rips1994,Polk1995,chater:oaksford:1999}).
...
for which the second property has to be either either false or unknown, \MA yz and \MI yz, (\ME yz and \MO yz, resp.), exclude each other.
